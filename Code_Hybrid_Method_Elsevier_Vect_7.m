function [D_7] = Code_Hybrid_method_Elsevier_Vect_7(n1, n2, n3, n4, n5, N)

format long
load('BestSol_GA_Vect_7.mat')
...
for i = 1:N
    ...
    K1(i,1) = (n2(i,1)/(n2(i,1)+n3(i,1)+n4(i,1)+n5(i,1)));
    K2(i,1) = (n5(i,1)/(n1(i,1)+n2(i,1)+n3(i,1)+n4(i,1)));
    K3(i,1) = (n4(i,1)/(n1(i,1)+n2(i,1)+n3(i,1)+n5(i,1)));
    
    X(i,1) = (K1(i,1)/(K1(i,1)+K2(i,1)+K3(i,1)));
    X(i,2) = (K2(i,1)/(K1(i,1)+K2(i,1)+K3(i,1)));
    X(i,3) = (K3(i,1)/(K1(i,1)+K2(i,1)+K3(i,1)));
    Xx = [X(i,1) X(i,2) X(i,3)];
