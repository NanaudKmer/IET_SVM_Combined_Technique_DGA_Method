function [D_6] = Code_Hybrid_method_Elsevier_Vect_6(n1, n2, n3, n4, n5, N)

format long
load('BestSol_GA_Vect_6.mat')
...
for i = 1:N
    ...
    X(i,1) = (n2(i,1)/(n2(i,1)+n4(i,1)+n5(i,1)));
    X(i,2) = (n4(i,1)/(n2(i,1)+n4(i,1)+n5(i,1)));
    X(i,3) = (n5(i,1)/(n2(i,1)+n4(i,1)+n5(i,1)));
